...
module.exports = [
  // index.js
  {
    ...
    entry: ["babel-polyfill", `${distroSourcePath}/${mainFileName}`],
    output: {
    ...
    module: {
      rules: [
        ...
        {
          test: /\.js$/,
          include: [path.resolve(__dirname, `${distroSourcePath}/js/`)],
            ...
            },
            {
              ...
              options: {
                resources: [
                  path.resolve(
                    __dirname,
                    "Client/Build/scss/variables/_variables.scss"
                  ),
                  path.resolve(
                    __dirname,
                    "Client/Build/scss/mixins/_mixins.scss"
                  )
                ]
              }
            }
